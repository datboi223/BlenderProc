...
print('target_bop_objs = ', len(target_bop_objs), target_bop_objs)
...
for i in range(args.num_scenes):
    ...
    sampled_target_bop_objs = list(np.random.choice(target_bop_objs, size=20, replace=True))
    ...
    while cam_poses < 25:
        # Sample location
        location = bproc.sampler.shell(center = [0, 0, 0], radius_min = 0.45, radius_max = 1.08,
                                       elevation_min = 5, elevation_max = 89)
